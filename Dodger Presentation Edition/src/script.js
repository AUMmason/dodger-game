...
var score = 0;//unter 1000 rot, unter 5000 orange, unter 10000 gr�n, ab 20000 blau
...
function Scorecount() {
    if (gamestatus == 1) {
        ...
        if (gamestatus == 2) {
            ...
            var currenthighscore = $('#credhighscore').html();
            currenthighscore = parseInt(currenthighscore);
            if(score > currenthighscore){
              document.getElementById('newhighscore').innerHTML = 'Congratulations new Highscore';
            }
...
//        document.getElementById('pattern').innerHTML = pattern;  Zeigt die aktuelle Nummer welche f�r eine Pattern zugewiesen wurde
    }

    Scorecount(); // Jedes mal wenn die Balken pattern gewechselt wird, wird die score um 10 erh�ht
    Balkenstop();// Schlie�t die Balken
...
var gameinterval = setInterval('Balkenauswahl()', diftime2);
